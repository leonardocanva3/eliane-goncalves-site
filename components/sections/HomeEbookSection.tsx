    ...
    <Section className="relative overflow-hidden bg-[var(--color-surface-muted)]/60">
      ...
      <Container>
        <div className="grid gap-10 lg:grid-cols-[0.82fr_1fr] lg:items-center lg:gap-16">
          <div className="relative mx-auto w-full max-w-[21rem] lg:max-w-[24rem]">
          ...
          <div className="relative">
            ...
            <h2 className="mt-6 max-w-2xl text-[2.35rem] font-semibold leading-[1.06] tracking-tight text-[var(--color-navy)] sm:text-[3rem] lg:text-[3.45rem]">
              O Poder
              <span className="block text-[var(--color-brand-blue)]">
                Mentalidade Positiva
              </span>
            </h2>
            <div className="mt-7 max-w-2xl space-y-5 text-base leading-8 text-[var(--color-text-muted)] sm:text-lg">
              <p>
            ...
            <p className="mt-7 inline-flex rounded-full border border-[rgba(201,161,91,0.32)] bg-white/70 px-4 py-2 text-sm font-semibold text-[var(--color-navy)] shadow-[0_12px_30px_rgba(13,43,82,0.045)]">
